...
# Enemy setup - Increase enemy size by 10%
enemy_size = int(50 * 1.1)  # enemies are now 10% bigger
enemies = []
spawn_interval = 10000  # 10 seconds in milliseconds
...
while running:
    ...
    if current_time - last_spawn_time >= spawn_interval:  # check if 10 seconds have passed
